...
public partial class @Engine: IInputActionCollection2, IDisposable
{
    ...
    ~@Engine()
    {
        ...
        UnityEngine.Debug.Assert(!m_Refereeing.enabled, "This will cause a leak and performance issues, Engine.Refereeing.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_GazingInMirror.enabled, "This will cause a leak and performance issues, Engine.GazingInMirror.Disable() has not been called.");
    }
    ...
    public struct RefereeingActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public RefereeingActions(@Engine wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct GazingInMirrorActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public GazingInMirrorActions(@Engine wrapper) { m_Wrapper = wrapper; }
        /// <summary>
